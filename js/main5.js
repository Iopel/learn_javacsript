...
console.log(wordsList(myStr, 'no')); 
console.log(wordsList(myStr, 'rep')); 
...
let getWeekDay = (date) => {
    ...
    return days[dayNow.getDay()];

};

console.log(getWeekDay('2021-02-15')); 
console.log(getWeekDay('2021-01-20')); 
console.log(getWeekDay('2021-01-26')); 
...
console.log(getDateAgo('2021-01-20', 20));
...
let Car = function (engine, model, name, year) {
  ...
  console.log(getLocalDay('2021-01-19')); 
